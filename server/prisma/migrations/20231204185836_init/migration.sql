...
INSERT INTO "new_Team" ("armourFront", "armourSide", "armourTop", "cross", "def", "desc", "effects", "faction", "height", "id", "imgSide", "imgTop", "mat", "motivation", "name", "nickname", "order", "points", "rat", "reactions", "save", "skill", "specials", "speed", "target", "transport", "transporting", "type", "unit", "weapons", "width") SELECT "armourFront", "armourSide", "armourTop", "cross", "def", "desc", "effects", "faction", "height", "id", "imgSide", "imgTop", "mat", "motivation", "name", "nickname", "order", "points", "rat", "reactions", "save", "skill", "specials", "speed", "target", "transport", "transporting", "type", "unit", "weapons", "width" FROM "Team";
DROP TABLE "Team";
